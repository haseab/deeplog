...
export function ExpandableDescription({
  ...
  return (
    ...
    >
      <div className="w-full overflow-hidden text-ellipsis text-base md:text-sm group-hover:text-accent-foreground transition-colors min-w-0 max-w-full md:truncate md:whitespace-nowrap break-words">
        <ReactMarkdown
          components={{
